...
# Set title for safari page name!
st.set_page_config(page_title="Super Dashboard", page_icon=":bar_chart:", layout="wide") # Merk at "page_icon" er en streamlit emoji, dette kan endre til hva som helst!

# Set a titlte for page itself!
st.title(" :bar_chart: Super Dashboard Exploratory Data Analysis!")
st.markdown("<style>div.block-container{padding-top:1rem;}</style>", unsafe_allow_html=True) # Changing the title cordinator/place in page. 


# Let user upload fils"
...
# Merk, filen må runes med "streamlit run fil_navn"